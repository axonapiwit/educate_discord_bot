...
client.on('messageCreate', msg => {
    ...
    const subjects = (day) => {
        if (day == 1) {
            return msg.reply('225351[2] Computer and Network Security ความปลอดภัยบนคอมพิวเตอร์และเครือข่าย เวลา 13.00-15.00');
        }
        if (day == 2) {
        ...
        if (day == 3) {
            return msg.reply('227481[2] Software Quality and Measurement คุณภาพและการวัดซอฟต์แวร์ เวลา 13.00-16.00');
        }
        if (day == 4) {
